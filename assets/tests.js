...
define('dummy/tests/controllers/tutorial.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | controllers/tutorial.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/tutorial.js should pass jshint.');
  });
});
